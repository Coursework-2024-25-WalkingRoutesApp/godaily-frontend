...
const val SEND_VERIFICATION_CODE_URL = "/send-verification-code"
const val CHECK_VERIFIED_URL = "/check-verified"
const val CHECK_VERIFICATION_CODE_URL = "/check-verification-code"
